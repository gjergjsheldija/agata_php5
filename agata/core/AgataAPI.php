...
class AgataAPI {
    ...
    function AgataAPI() {
        ...
        define('AGATA_PATH', dirname(dirname(__FILE__)));
        ...
        if (!is_dir(AGATA_PATH)) {
            ...
            include_once AGATA_PATH . "/core/AgataCompatibility.php";
            include_once AGATA_PATH . "/core/AgataConnection.php";
            include_once AGATA_PATH . "/core/AgataQuery.php";
            include_once AGATA_PATH . "/core/AgataError.php";
            include_once AGATA_PATH . "/core/AgataDataSet.php";
            include_once AGATA_PATH . "/core/Project.php";
            include_once AGATA_PATH . "/core/CoreReport.php";
            include_once AGATA_PATH . "/core/Layout.php";
            include_once AGATA_PATH . "/core/AgataCore.php";
            include_once AGATA_PATH . "/core/AgataConfig.php";
            include_once AGATA_PATH . "/util/Dialog.php";
            include_once AGATA_PATH . "/util/Trans.php";
            include_once AGATA_PATH . "/util/XmlArray.php";
            include_once AGATA_PATH . "/util/AgataOO.php";
            include_once AGATA_PATH . "/reports/AgataReport.php";
        }
    }
