...
*/
  function _cell_to_packed_rowcol($cell)
    ...
    if ($col >= 256) {
        adie("Column in: $cell greater than 255 ");
        }
    if ($row >= 16384) {
        adie("Row in: $cell greater than 16384 ");
        }
...
*/
  function _fact()
    ...
    adie("Sintactic error: ".$this->_current_token.", lookahead: ".
