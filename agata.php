...
include_once 'classes/util/Trans.php';
include_once 'classes/core/Project.php';
include_once 'classes/core/CoreReport.php';
include_once 'classes/core/Dictionary.php';
include_once 'classes/core/Label.php';
include_once 'classes/core/Layout.php';
include_once 'classes/core/AgataError.php';
include_once 'classes/core/AgataQuery.php';
include_once 'classes/core/AgataDataSet.php';
include_once 'classes/core/AgataConnection.php';
include_once 'classes/core/AgataCompatibility.php';
include_once 'classes/core/AgataCore.php';
include_once 'classes/core/AgataConfig.php';
include_once 'classes/core/AgataInterface.php';
